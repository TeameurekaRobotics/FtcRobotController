...
@Autonomous(name = "AutonomousDuck", group = "TFOD-Autos")
@Disabled
public class MyTfodTest extends LinearOpMode
{
    //Instantiate Hardware setup
    TestBotHardwareSetup robot = new TestBotHardwareSetup();
